 ...
 * License: MIT
 */
angular.module("ui.bootstrap", ["ui.bootstrap.tpls","ui.bootstrap.tooltip","ui.bootstrap.position","ui.bootstrap.bindHtml","ui.bootstrap.dropdown","ui.bootstrap.collapse","ui.bootstrap.carousel","ui.bootstrap.pagination","ui.bootstrap.modal"]);
angular.module("ui.bootstrap.tpls", ["template/tooltip/tooltip-html-popup.html","template/tooltip/tooltip-html-unsafe-popup.html","template/tooltip/tooltip-popup.html","template/tooltip/tooltip-template-popup.html","template/carousel/carousel.html","template/carousel/slide.html","template/pagination/pager.html","template/pagination/pagination.html","template/modal/backdrop.html","template/modal/window.html"]);
/**
...
.controller('CarouselController', ['$scope', '$element', '$interval', '$animate', function ($scope, $element, $interval, $animate) {
  ...
  $scope.next = function(lenFix) {
    ...
    //Sometimes slides has length +1 greater than
    //it should be. 
    //This is a hack to fix that 
    if(!!lenFix)
        var newIndex = (self.getCurrentIndex() + 1) % (slides.length-1);
  ...
  $scope.prev = function(lenFix) {
    ...
    //See comments above
    if(!!lenFix)
        var newIndex = self.getCurrentIndex() - 1 < 0 ? (slides.length - 2) : self.getCurrentIndex() - 1;
